<?php
	$adresa="550 E. Loveland Avenue Loveland, Ohio 45140-2930"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=5136830110;// Broj koji se poziva na dugme CALL US
